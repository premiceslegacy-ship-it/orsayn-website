              ...
              <div className="relative w-full overflow-hidden bg-ink/5 group h-[220px] md:h-[450px] lg:h-[600px] border border-ink/10">
                ...
                >
                  ...
                  <motion.div style={{ y }} className="absolute inset-0 w-full h-[120%] -top-[10%]">
                    <Image
                      src="/images/ascension-img.webp"
                      alt="Ascension - Architecture de l'Excellence"
                      fill
                  ...
                  {/* Gradient overlay */}
                  <div className="absolute bottom-0 left-0 w-full h-24 md:h-32 bg-gradient-to-t from-black/50 to-transparent pointer-events-none opacity-60 z-10"></div>
                </motion.div>
                ...
                >
                  <span className="text-[8px] md:text-[9px] uppercase tracking-[0.2em] text-paper/90 block font-medium flex items-center gap-2 md:gap-3 shadow-sm">
                    ...
                    {locale === 'fr' ? 'Fig. 02 — Ascension' : 'Fig. 02 — The Ascent'}
                  </span>
                </motion.div>
              </div>
