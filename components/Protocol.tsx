        ...
        <div>
          <div className="flex justify-between items-baseline mb-6 md:mb-8 lg:mb-10">
            <motion.span
              ...
              className="font-serif text-2xl md:text-4xl transition-colors duration-500 ease-luxury"
            >
              {step.id}
            </motion.span>
          ...
          <h3 className="font-serif text-lg md:text-2xl lg:text-2xl text-ink mb-3 md:mb-4 group-hover:translate-x-1 transition-transform duration-500 ease-luxury uppercase tracking-tight">
            {step.title}
          </h3>

          <p className="text-xs md:text-sm font-light text-ink/60 leading-relaxed mb-6 md:mb-8 whitespace-pre-line">
            {step.description}
          </p>
        </div>
...
const Protocol: React.FC = () => {
  ...
  return (
    <section id="approche" className="py-20 md:py-32 lg:py-40 bg-paper relative overflow-hidden">
        ...
        <div className="mb-12 md:mb-24 lg:mb-32 grid grid-cols-1 xl:grid-cols-12 gap-8 md:gap-12">
          <div className="xl:col-span-5 flex flex-col justify-end text-center md:text-center xl:text-left">
            ...
            <h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-ink leading-[1]">
              {t('titleLine1')}<br />
              <span className="italic text-ink/40">{t('titleLine2')}</span>
            </h2>
          </div>
